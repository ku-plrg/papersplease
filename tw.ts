// copied from $fresh/plugins/tailwind.ts
// fix static css directory
...
async function initTailwind(
  ...
  return await (await import("$fresh/plugins/tailwind/compiler.ts"))
    .initTailwind(
      config,
      options,
    );
...
export default function tailwind(
  ...
  let staticDir = path.join(import.meta.dirname!, "static"); // here!
